...
const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      ...
      name: 'changePassword',
      component: () =>
        import(/* webpackChunkName: "changePassword" */ '@/views/ChangePasswordView.vue'),
    ...
    },
    {
      ...
      name: 'schoolcalendar',
      component: () =>
        import(/* webpackChunkName: "schoolcalendar" */ '@/views/schedule/SchoolCalendar.vue'),
    ...
    },
    {
      ...
      component: () =>
        import(/* webpackChunkName: "studentHomework" */ '@/views/StudentHomeworkView.vue'),
    ...
    },
    {
      ...
      name: 'homeworkDetail',
      component: () =>
        import(/* webpackChunkName: "homeworkDetail" */ '@/views/HomeworkDetailView.vue'),
    ...
    },
    {
      ...
      component: () =>
        import(/* webpackChunkName: "teacherHomeworkList" */ '@/views/TeacherHomeworkListView.vue'),
    ...
    },
    {
      ...
      name: 'teacherGrading',
      component: () =>
        import(/* webpackChunkName: "teacherGrading" */ '@/views/TeacherGradingView.vue'),
...
router.addRoute({
  path: '/admin/base-info-import',
  name: 'BaseInfoImport',
  component: () => import('@/views/BaseInfoImportView.vue'),
  meta: { requiresAuth: true, title: '基础数据导入' },
})
